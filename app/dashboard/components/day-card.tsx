    ...
    return (
        <div>
                    ...
                    {(onClose) => (
                        ...
                        <ModalBody>
                            ...
                            {dayIntake.map((intake, ix) => (
                                ...
                                key={ix}
                                label='Liters'
                                value={dayIntake[ix].toString()}
                                type="number"
                                step={0.1}
                                onChange={(e) => {
                                    setDayIntake((prev) => {
                                        const newDayIntake = [...prev];
                                        newDayIntake[ix] = e.target.value === '' ? 0 : parseFloat(e.target.value);
                                        return newDayIntake;
                                    });
                                }}
                                // color={getInputColor()}
                            ...
                            <Button 
                                ...
                                onPress={() => {
                                    ...
                                    setWeekIntake((prev) => {
                                        ...
                                        newWeekIntake[index] = dayIntake.reduce((a, b) => a + b, 0);
            ...
            >
                ...
                <div>
                    <label className='cursor-pointer'>{weekIntake[index].toFixed(2)}</label>
